...
description: 'A guide to better frontend development and design principles for beginners part 1. UX, needs over design.'
image: '/blog/frontend-part-1.webp'
tags: ['frontend', 'development', 'design', 'ux', 'principles']
date: '2026-01-14'
isPublished: true
---
...
In this blog, I will share some key principles that every frontend developer should know. So, let's get started. For a deeper dive into JavaScript on the frontend, check out [JavaScript for Frontend Part 1](/blog/javascript-for-frontend-part-1). Resources like [web.dev](https://web.dev) also cover modern frontend patterns.
