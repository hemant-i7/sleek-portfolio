...
image: '/blog/routing-in-nextjs.webp'
tags: ['frontend', 'development', 'nextjs', 'app-router', 'routing']
date: '2026-01-29'
isPublished: true
---
...
Next.js has a file-system-based routing system. The URLs you can access in your browser are determined by how you organize your files and folders within your project. For more on the framework, see the [Next.js docs](https://nextjs.org/docs). After routing, you may want to read [Next.js data fetching and security](/blog/nextjs-data-fetching).
...
- _https://hemant.engineer/blog_
- _https://hemant.engineer/blog/first_
- _https://hemant.engineer/blog/second_
...
Now, if you visit _https://hemant.engineer/products/100_, the _params.productId_ will be _100_, and it will render dynamically.
...
- _https://hemant.engineer/categories/electronics_
- _https://hemant.engineer/categories/fashion_
- _https://hemant.engineer/categories/electronics/phones_
- _https://hemant.engineer/categories/fashion/shoes_
...
- _https://hemant.engineer/docs_
- _https://hemant.engineer/docs/getting-started_
- _https://hemant.engineer/docs/api/reference_
