...
description: 'A guide to JavaScript for frontend development for beginners part 1. Variables, functions, async, DOM.'
image: '/blog/javascript-part-1.webp'
tags: ['frontend', 'development', 'javascript', 'beginner', 'tutorial']
date: '2026-01-19'
isPublished: true
---
...
Hello there! lets start with basic to advanced JavaScript concepts. This is just a guide not a tutorial to learn JavaScript. You can use this as a reference to learn JavaScript. This is the first part of the series. For design and UX principles, see [Better Frontend Part 1](/blog/better-frontend-part-1). The [MDN JavaScript guide](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide) is a solid external reference.
