...
description: 'A guide to Next.js data fetching mistakes and security vulnerabilities. RSC, caching, Server Actions.'
image: '/blog/nextjs-data-fetching.webp'
tags: ['frontend', 'development', 'nextjs', 'data-fetching', 'security']
date: '2026-01-24'
isPublished: true
---
...
Just use async await in react server component and good to go. For how routes work in the app, see [Routing in Next.js](/blog/routing-in-nextjs). The [Next.js data fetching docs](https://nextjs.org/docs/app/building-your-application/data-fetching) explain the full picture.
...
```typescript
// app/test/page.tsx
// Example import (not actually used)
// import TodoList from './components/todo-list'
