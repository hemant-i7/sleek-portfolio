...
export const achievements = [
  { title: '1st Place – IIT Roorkee 44-hour Hackathon', where: 'IIT Roorkee', note: 'Seventh hackathon win. Team: Kaustubh Bane, Hasan Sayyed, Morvi Panchal.', emoji: '🥇', description: 'Premier 44-hour hackathon at IIT Roorkee.', url: 'https://www.iitr.ac.in/', postUrl: '', postImageUrl: '' },
  { title: 'Winner – TechSurf 2025', where: 'TechSurf', note: '', emoji: '🏆', description: 'Contentstack\'s annual flagship hackathon for India\'s next-gen developers. 40,000+ participants over 5 editions; certification, pitch, and finale rounds.', url: 'https://contentstack.com/techsurf', postUrl: '', postImageUrl: '' },
  { title: '1st Runner-up – Webathon 2025 (National)', where: 'Webathon', note: '', emoji: '🥈', description: 'National-level hackathon by ACM-MHSSCE; multi-round with startup funding and mentorship.', url: 'https://webathon.mhsscoe.acm.org/', postUrl: '', postImageUrl: '' },
  { title: '2nd Runner-up – Saboo Siddik College Hackathon (National)', where: 'Saboo Siddik College, Mumbai', note: '', emoji: '🥉', description: 'National hackathon at M.H. Saboo Siddik College of Engineering, Mumbai.', url: 'https://webathon.mhsscoe.acm.org/', postUrl: '', postImageUrl: '' },
  { title: '5th Place – Google Build & Blog Hackathon, Google Office BKC (National)', where: 'Google Office BKC', note: '', emoji: '🎯', description: 'Build & Blog Marathon at Google Mumbai (BKC). Theme: Data to Generative AI with Google Cloud; mentorship from Google.', url: 'https://gdg.community.dev/', postUrl: '', postImageUrl: '' },
  ...
  { title: 'Top Performer – Global Digital Health Summit Hackathon', where: 'NMACC (International)', note: '', emoji: '⚡', description: 'Hackathon at Global Digital Health Summit; digital health, AI, and telemedicine focus.', url: 'https://cdac.in/index.aspx?id=lu_GDHS', postUrl: '', postImageUrl: '' },
  { title: 'Top 5 – Technovation', where: 'Amrutvahini College Nashik (National)', note: '', emoji: '🚀', description: 'National tech hackathon at Amrutvahini College of Engineering, Nashik.', url: '', postUrl: '', postImageUrl: '' },
];
